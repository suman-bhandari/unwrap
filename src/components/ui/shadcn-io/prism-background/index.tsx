...
// @ts-ignore - OGL library types are not available
...
export const PrismBackground = forwardRef<HTMLDivElement, PrismBackgroundProps>(({
  className,
  height = 3.5,
  baseWidth = 5.5,
  ...
  return <div ref={ref} className={cn("w-full h-full relative", className)} {...domProps}>
